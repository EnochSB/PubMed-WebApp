...
| 팀원 | 담당 영역 | 주요 구현 |
|---|---|---|
| 하성범 | 요구사항 3·4, 프로젝트 기반 | 프로젝트 초기화, 개요 집계·차트, 논문 검색, 검색 오류 수정 및 통합 |
| 이채연 | 요구사항 5·6, 인증 | 챗봇·CSV 기능 초기 구현, Google OAuth 로그인 및 브랜치 통합 |
| 최영현 | 요구사항 1·2·7, 고도화·UI | PubMed 수집 구조의 객체지향화, 의료 미들웨어, 논문 의미 분류, 답변 스트리밍, Soft Glass UI 및 최종 통합 |
